...
export const layout = [
  ...
  {key: "margin-x", prop: ["margin-right", "margin-left"], valueNames: dimSteps.map(e => `mx${e}`)},
  {key: "margin-y", prop: ["margin-top", "margin-bottom"], valueNames: dimSteps.map(e => `my${e}`)},
  ...
  {key: "padding-x", prop: ["padding-right", "padding-left"], valueNames: dimSteps.map(e => `px${e}`)},
  {key: "padding-y", prop: ["padding-top", "padding-bottom"], valueNames: dimSteps.map(e => `py${e}`)},
