...
export const layout = [
  ...
  {key: "margin-start", prop: "", valueNames: dimSteps.map(e => `ms${e}`)},
  {key: "margin-end", prop: "", valueNames: dimSteps.map(e => `me${e}`)},
  ...
  {key: "padding-start", prop: "", valueNames: dimSteps.map(e => `ps${e}`)},
  {key: "padding-end", prop: "", valueNames: dimSteps.map(e => `pe${e}`)},
  ...
  {key: "start", prop: "", valueNames: sideSteps.map(e => `start${e}`)},
  {key: "end", prop: "", valueNames: sideSteps.map(e => `end${e}`)},
